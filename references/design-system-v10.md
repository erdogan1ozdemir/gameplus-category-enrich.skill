...
- **"Hızlı Özet" başlığı `<div>`** (heading değil — SEO); boyut 19 (mobil 16). **TLDR bloğu ana başlığın (H2) HEMEN ALTINA taşınır** (port otomatik yapar; tüm kategorilerde standart). Bullet metni gövde paragrafıyla aynı punto (16/mobil 15).
